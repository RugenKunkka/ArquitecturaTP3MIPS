...
module DebugUnitFSM
    ...
    */  
        ...
        // Other IO Ports
        input wire i_halt_fromTargetToDUFSM,            // Halt coming from Control Unit
        output wire  o_clockIgnore_fromDUFSMToTarget    // Clock Enable to do Stepping
    );
  ...
  /*
    ...
    */
    ...
    // For Clock
    assign o_clockIgnore_fromDUFSMToTarget = regClockIgnore;
    ...
    always@(*) begin
        ...
        case(regCurrentState)
            ...
            STEP_MODE_RUNNING_STATE: begin
                if (~i_halt_fromTargetToDUFSM) begin
                    regClockIgnore_next = LOW;
                end else begin   
                    regClockIgnore_next = HIGH;
                end
