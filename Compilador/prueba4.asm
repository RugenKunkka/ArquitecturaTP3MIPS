// prueba4.asm
// Probar Instrucciones de Carga y Store:
...
LBU	r4, 1(r13)	//	0000000E(r04) <- [E(r13) + 1] (Mem 0x0E / d14)		Cargar el contenido de la memoria d14 en r4 sin signo  8 LSB
LHU	r5, 1(r14)	//	0000A00F(r05) <- [E(r14) + 1] (Mem 0x0F / d15)		Cargar el contenido de la memoria d15 en r5 sin signo 16 LSB
LWU	r6, 1(r15)	//	0000A010(r06) <- [E(r15) + 1] (Mem 0x10 / d16)		Cargar el contenido de la memoria d16 en r6 sin signo 
