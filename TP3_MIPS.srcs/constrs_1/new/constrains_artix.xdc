...
set_property -dict { PACKAGE_PIN B8    IOSTANDARD LVCMOS33 } [get_ports { i_reset_fromPin }]; #IO_L12P_T1_MRCC_16 Sch=btn[3]
...
##USB-UART Interface
#es el rx del usb
set_property -dict {PACKAGE_PIN D10 IOSTANDARD LVCMOS33} [get_ports {o_tx_fromPin}];
#es el tx del usb
set_property -dict {PACKAGE_PIN A9 IOSTANDARD LVCMOS33} [get_ports {i_rx_fromPin}];
